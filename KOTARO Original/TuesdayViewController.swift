...
class TuesdayViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        titleTextField.text = saveData.object(forKey: "Tuetitle") as? String
        contentTextView.text = saveData.object(forKey: "Tuecontent") as? String
    ...
    @IBAction func saveMemo(){
        ...
        saveData.set(titleTextField.text, forKey: "Tuetitle")
        saveData.set(contentTextView.text, forKey: "Tuecontent")
    }
